...
//        $this->client->setModel(GeminiClient::MODEL_PRO);
    ...
    private function buildPrompt(): string
    {
        $prompt = strtr("
            ...
            [
                ...
                '{character_prompt_rules}' => $this->getCharacterPromptRules(),
                '{world_prompt_rules}' => $this->getWorldPromptRules(),
                '{character_json_structure}' => $this->getCharacterJsonStructure(),
    ...
    private function getCharacterPromptRules(): string
    {
        return <<<PROMP
    ...
    public function getCharacterJsonStructure()
    {
       $json = <<<PROMP
            ...
            "character": {
                ...
                "chaotic_temperature": {chaotic_temperature},
                "positive_temperature": {positive_temperature},
                "lore_temperature": {lore_temperature},
                "temperature": {temperature},
                "how_many_attributes_to_fill": {how_many_attributes_to_fill}
                "attributes_to_fill": {attributes_to_fill}
            },
        PROMP;
